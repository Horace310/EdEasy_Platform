...
<body style="background-image:url(images/Back_Index.jpg);background-repeat:no-repeat;background-size:100%;">
  ...
  <tr>
    ...
    <td valign="top">
        <table width="99%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><label>Name&nbsp;<b style="color:#F00; font-size:22px;">*</b>&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
          ...
          <tr>
          	<td><label>E-mail&nbsp;<b style="color:#F00; font-size:22px;">*</b>&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
                ...
                if(isset($_POST['pwd']) && $_POST['pwd']!=null && isset($_POST['rpwd']) && $_POST['rpwd']!=""){
                    if($_POST['pwd'] != $_POST['rpwd']){
                        ...
                        if(empty($queryArray['EMAIL'])){
                            ...
                            mysqli_query($con,"INSERT INTO login VALUES ('$name','{$_POST['email']}','{$_POST['pwd']}')");
                            mysqli_close($con);
                            echo "<script language='javascript'>
