...
<body text=navy>
<center> <font face="ar christy" color=red style="font-size: 80px; text-shadow: 0px 0px 3px black"> Videos</font></center>
<br><br>
<table align=center width=60% cellspacing=2>
<?php	
    echo "<center><font color=black size=3 face='Arial' style='text-shadow: 0px 0px 2px red;'>This page will have the videos based on category. Currently a work in progress. </font></center>";
